...
PLAYERS_EMPTY_TEXT = (
    "Игроки пока не загружены. PandaScore не вернул составы/игроков для текущих команд.\n\n"
    "Нажмите 🔄 Обновить данные или откройте команду, чтобы попробовать загрузить состав. "
    "Если составы недоступны по тарифу/API, бот покажет только команды и матчи."
)
